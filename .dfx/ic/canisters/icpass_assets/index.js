...
import { idlFactory } from './icpass_assets.did.js';
export { idlFactory } from './icpass_assets.did.js';
// CANISTER_ID is replaced by webpack based on node environment
export const canisterId = process.env.ICPASS_ASSETS_CANISTER_ID;
 ...
 * @return {import("@dfinity/agent").ActorSubclass<import("./icpass_assets.did.js")._SERVICE>}
 */
...
/**
 * A ready-to-use agent for the icpass_assets canister
 * @type {import("@dfinity/agent").ActorSubclass<import("./icpass_assets.did.js")._SERVICE>}
 */
export const icpass_assets = createActor(canisterId);
